! function (t) {
    ...
    e.prototype.init = function () {
        c3.generate({
            bindto: "#chart",
            data: {
                columns: [["Desktops", 35, 20, 50, 40, 60, 50], ["Tablets", 200, 130, 90, 240, 130, 220], ["Mobiles", 300, 200, 160, 400, 250, 250]],
                type: "bar",
                colors: {
                    Desktops: "#dcdcdc",
                    Tablets: "#4ac6ec",
            ...
            data: {
                columns: [["Desktops", 40, 20, 50, 40, 60, 50], ["Tablets", 200, 130, 90, 240, 130, 220], ["Mobiles", 300, 200, 160, 400, 250, 250], ["Watch", 200, 130, 90, 240, 130, 220], ["iPad", 130, 120, 150, 140, 160, 150]],
                types: {
                    Desktops: "bar",
                    Tablets: "bar",
                    Mobiles: "spline",
            ...
            bindto: "#roated-chart",
            data: {
                columns: [["Desktops", 70, 200, 100, 400, 150, 250], ["Tablets", 50, 20, 10, 40, 15, 25]],
                types: {
                    Desktops: "bar"
                },
                colors: {
            ...
            color: {
                pattern: ["#4ac6ec", "#7551e9", "#4ac6ec", "#7551e9"]
            },
            axis: {
                x: {
                    label: "Sepal.Width",
